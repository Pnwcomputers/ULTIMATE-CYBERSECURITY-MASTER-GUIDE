...
- **Mobile Platform Pentesting?** → [Mobile Security](Mobile/) + [Mobile Pentest SOP](Mobile/mobile_pentest_sop.md) + [NetHunter Setup](Mobile/OnePlus_A6003/Kali_NetHunter.md)
