...
## 🔗 Reference Links
* **Product Link:** [HiLetgo USB Logic Analyzer (Amazon search)](https://www.amazon.com/s?k=HiLetgo+USB+Logic+Analyzer+24MHz+8CH) — sold under rotating ASINs, so search rather than a single fixed listing
