...
# Recursive File Search and Backup Script
# Usage: ./recursive_search.sh <directory_to_search>
...
if [[ -z "${DIR_SEARCH}" ]]; then
    echo "Warning: you did not provide an argument in the form of a file path. Defaulting to /var/log."
