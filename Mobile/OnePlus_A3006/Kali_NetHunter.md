...
## 🏆 Goal
Produce a fully operational Kali NetHunter environment on the OnePlus 6 for mobile penetration testing - wireless attacks, HID/BadUSB, Bluetooth Arsenal, Wardriving, and full Kali chroot available from the NetHunter app.

## 📋 When to Use
- Initial NetHunter installation after rooting the OnePlus 6
- After a LineageOS upgrade that requires reflashing the NetHunter image
- Troubleshooting a broken chroot or missing kernel features
...
## Related Files
- [Rooting.md](Rooting.md) - Phase-by-phase guide to get the OnePlus 6 to the state this guide assumes
- [Nethunter_SOP.md](Nethunter_SOP.md) - Field SOPs for operating NetHunter tools during engagements
