...
This repository is a **documentation and script collection**, not a software package with versions.
Security concerns fall into two categories:

| Category | Examples |
|---|---|
| **Scripts with bugs or dangerous behavior** | A script that does more than documented, unintended data exposure, unsafe defaults |
| **Operational security issues** | Hardcoded credentials accidentally committed, sensitive data in a file |
...
You'll receive a response within **72 hours**. If the issue is confirmed, it will be addressed
and you'll be credited in the fix commit (unless you prefer anonymity).

---

## ⚠️ This Repo Contains Offensive Security Tools
